void sensor_read()
{
  ...
  //Analog to digital conversion of the 6 sensor readings
  for (int i = 0; i<7; i++)
  {
...
/*inch_condns = ((sen[0] == 0 && sen[1] == 0 && sen[2] == 0 && sen[3] == 1 && sen[
 * 4] == 0 && sen[5] == 0 && sen[6] == 0) ||      //0 0 0 1 0 0 0 
...
forward_condns = (//(sen[0] == 0 && sen[1] == 0 && sen[2] == 0 && sen[3] == 1 && sen[4] == 0 && sen[5] == 0 && sen[6] == 0) ||      //0 0 0 1 0 0 0 
                  (sen[0] == 0 && sen[1] == 0 && sen[2] == 1 && sen[3] == 1 && sen[4] == 1 && sen[5] == 0 && sen[6] == 0)       //0 0 1 1 1 0 0 
                  //(sen[0] == 0 && sen[1] == 0 && sen[2] == 1 && sen[3] == 1 && sen[4] == 0 && sen[5] == 0 && sen[6] == 0) ||      //0 0 1 1 0 0 0
                  //(sen[0] == 0 && sen[1] == 0 && sen[2] == 0 && sen[3] == 1 && sen[4] == 1 && sen[5] == 0 && sen[6] == 0)         //0 0 0 1 1 0 0 
                  );
...
spl_node = ((sen[0] == 1 && sen[1] == 1 && sen[2] == 0 && sen[3] == 0 && sen[4] == 0 && sen[5] == 1 && sen[6] == 1) ||       //1 1 0 0 0 1 1
            //(sen[0] == 0 && sen[1] == 1 && sen[2] == 0 && sen[3] == 0 && sen[4] == 0 && sen[5] == 1 && sen[6] == 1) ||         //0 1 0 0 0 1 1
            //(sen[0] == 1 && sen[1] == 1 && sen[2] == 0 && sen[3] == 0 && sen[4] == 0 && sen[5] == 1 && sen[6] == 0) ||           //1 1 0 0 0 1 0
            ...
            //(sen[0] == 1 && sen[1] == 1 && sen[2] == 0 && sen[3] == 0 && sen[4] == 1 && sen[5] == 1 && sen[6] == 0) ||          //1 1 0 0 1 1 0
            //(sen[0] == 0 && sen[1] == 1 && sen[2] == 1 && sen[3] == 0 && sen[4] == 0 && sen[5] == 1 && sen[6] == 1)           //0 1 1 0 0 1 1
           );
y_condns = ((sen[0] == 0 && sen[1] == 1 && sen[2] == 1 && sen[3] == 1 && sen[4] == 1 && sen[5] == 1 && sen[6] == 0)        //0 1 1 1 1 1 0
            //(sen[0] == 0 && sen[1] == 1 && sen[2] == 1 && sen[3] == 1 && sen[4] == 1 && sen[5] == 0 && sen[6] == 0)||        //0 1 1 1 1 0 0              
            //(sen[0] == 0 && sen[1] == 0 && sen[2] == 1 && sen[3] == 1 && sen[4] == 1 && sen[5] == 1 && sen[6] == 0)        //0 0 1 1 1 1 0
            );  
//spl_node_track2 = ((sen[0] == 1 && sen[1] == 1 && sen[2] == 0 && sen[3] == 0 && sen[4] == 0 && sen[5] == 1 && sen[6] == 1) ||       //1 1 0 0 0 1 1
//            (sen[0] == 0 && sen[1] == 1 && sen[2] == 0 && sen[3] == 0 && sen[4] == 0 && sen[5] == 1 && sen[6] == 1) ||         //0 1 0 0 0 1 1
//            (sen[0] == 1 && sen[1] == 1 && sen[2] == 0 && sen[3] == 0 && sen[4] == 0 && sen[5] == 1 && sen[6] == 0) ||           //1 1 0 0 0 1 0
//            (sen[0] == 1 && sen[1] == 1 && sen[2] == 1 && sen[3] == 0 && sen[4] == 0 && sen[5] == 1 && sen[6] == 1) ||          //1 1 1 0 0 1 1
//            (sen[0] == 1 && sen[1] == 1 && sen[2] == 0 && sen[3] == 0 && sen[4] == 1 && sen[5] == 1 && sen[6] == 1)           //1 1 0 0 1 1 1
//           );
/*
y_condns = ((sen[0] == 0 && sen[1] == 0 && sen[2] == 1 && sen[3] == 1 && sen[4] == 1 && sen[5] == 1 && sen[6] == 0 && sen[7] == 0)||
            (sen[0] == 0 && sen[1] == 0 && sen[2] == 1 && sen[3] == 1 && sen[4] == 0 && sen[5] == 1 && sen[6] == 1 && sen[7] == 0)||
            (sen[0] == 0 && sen[1] == 0 && sen[2] == 1 && sen[3] == 1 && sen[4] == 0 && sen[5] == 1 && sen[6] == 0 && sen[7] == 0)||
            (sen[0] == 0 && sen[1] == 0 && sen[2] == 0 && sen[3] == 1 && sen[4] == 0 && sen[5] == 1 && sen[6] == 1 && sen[7] == 0)||
            (sen[0] == 0 && sen[1] == 1 && sen[2] == 1 && sen[3] == 0 && sen[4] == 0 && sen[5] == 1 && sen[6] == 1 && sen[7] == 0)||
            (sen[0] == 1 && sen[1] == 1 && sen[2] == 0 && sen[3] == 0 && sen[4] == 0 && sen[5] == 0 && sen[6] == 1 && sen[7] == 1)
            );
*/
}
